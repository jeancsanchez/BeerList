...
public class BeersRepositoryImpl implements BeersRepository {
    ...
    private final BeersDataSource.BeersLocalDataSource mLocalBeers;

    @Inject
    BeersRepositoryImpl(@Remote BeersDataSource remoteBeers, @Local BeersDataSource.BeersLocalDataSource localBeers) {
    ...
    @Override
    public void searchBeerByName(String query, @NonNull BeersDataSource.SearchBeerCallback callback) {
    ...
    @Override
    public void getFavoriteBeers(BeersDataSource.FavoriteBeersCallback favoriteBeersCallback) {
